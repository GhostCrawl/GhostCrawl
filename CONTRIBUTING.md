...
4. **Title your PR using Conventional Commits style:**
   ...
   feat(cli): add --timeout flag to ghostcrawl scrape
...
By signing off you certify that you wrote the code (or have the right to submit it) under the
[Apache License 2.0](LICENSE) terms. Full DCO text at <https://developercertificate.org>.
